...
> [!TIP]
> :desktop_computer: Press ***`Win + X`*** ![alt|50](https://github.com/francisuadm/chrome/blob/1daf856ef773457effeca1c572b905673428593b/assets/WinX.png|) and select Windows PowerShell (Admin) from the menu.
> 
